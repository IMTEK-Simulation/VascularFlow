...
def test_derivatives(basis_function_class, delta=1e-6, rtol=1e-6, plot=True):
    ...
    # Finite-differences test of the first derivative
    ...
    # Finite-differences test of the second derivative
    sd_fd_ni = (v_plus_ni - 2 * v_ni + v_minus_ni) / (delta**2)
    np.testing.assert_allclose(sd_ni, sd_fd_ni, rtol=1e-3)
